...
const OPConsultationService = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.content}>
                <Animated.Text style={[styles.title, { opacity: titleOpacity }]}>OP CONSULTATION SERVICES</Animated.Text>
            ...
            <View style={styles.conta}>
                ...
                <CustomButton 
                        label="NEAR BY YOU"
                        color="#00a1e4"
                        onPress={() => navigation.navigate('OPConsultationService')}
                    />
                    <CustomButton
                        label="SPECIALITY"
                        onPress={() => navigation.navigate('OPCSpeciality')}
                    />
                    <CustomButton
                        label="SPACIALITY"
                        onPress={() => navigation.navigate('OPCSpaciality')}
                    />
                </View>
            </View>
            <View style={{ flex: 1, alignItems: 'center' }}>
                <Image style={{ margin: 30, height: 150, width: 170 }} source={require('../../assets/images/opconsultationservices.png')} />
...
export default OPConsultationService;
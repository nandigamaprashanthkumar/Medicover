...
const RehabPaliativeCare = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.content}>
                <Animated.Text style={[styles.title, { opacity: titleOpacity }]}>REHABILITATION SERVICE</Animated.Text>
            ...
            <View style={styles.tabRow}>
                    <CustomButton
                        label="NEURO"
                        onPress={() => navigation.navigate('RehabilitationServices')}
                    />
                    <CustomButton
                        label="PULMANOLOGY"
                        onPress={() => navigation.navigate('RehabPulmanology')}
                    />
                    <CustomButton
                        label="ORTHO"
                        onPress={() => navigation.navigate('RehabOrtho')}
                    />
                </View>
                <View style={styles.tabRow}>
                    <CustomButton
                        label="CARDIAC"
                        onPress={() => navigation.navigate('RehabCardiac')}
                    />
                    <CustomButton
                        label="GARIATRIC"
                        onPress={() => navigation.navigate('RehabGariatric')}
                    />
                    <CustomButton
                        label="PALIATIVE CARE"
                        color="#00a1e4"
                        onPress={() => navigation.navigate('RehabPaliativeCare')}
                    />
                </View>
            </View>
            <View style={{ flex: 1, alignItems: 'center' }}>
                <Image style={{ margin: 30, height: 180, width: 150 }} source={require('../../assets/images/rehabilitationservc.png')} />
                <TouchableOpacity style={styles.serviceButton} onPress={handleServicePress}>
...
export default RehabPaliativeCare;
        ...
        >
            ...
            >
                <View style={styles.overlay}>
                    <Image source={require('../../assets/images/intro1i.png')} style={{marginBottom:10}} />
                    <Text style={{ color: 'white',marginBottom:8,fontSize:16,opacity:0.7 }}>We have the best advisors</Text>
                    <Text style={{ color: 'white',marginBottom:100,fontSize:16,opacity:0.7 }}>who can assist you better and better</Text>

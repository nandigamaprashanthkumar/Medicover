...
const MedicalEquipPurchase = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.content}>
                <Animated.Text style={[styles.title, { opacity: titleOpacity }]}>MEDICAL EQUIPMENT SERVICE</Animated.Text>
            ...
            <View style={styles.conta}>
                ...
                <CustomButton 
                        label="RENTAL ITEM"
                        onPress={() => navigation.navigate('MedicalEquipmentService')}
                    />
                    <CustomButton
                        label="PURCHASE"
                        color="#00a1e4"
                        onPress={() => navigation.navigate('MedicalEquipPurchase')}
                    />
                    <CustomButton
                        label="VENDORS"
                        onPress={() => navigation.navigate('MedicalEquipVendors')}
                    />
                </View>
            </View>
            <View style={{ flex: 1, alignItems: 'center' }}>
                <Image style={{ margin: 30, height: 150, width: 150 }} source={require('../../assets/images/medicalequipserv.png')} />
...
export default MedicalEquipPurchase;
...
const HealthInsuranceServices = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.content}>
                <Animated.Text style={[styles.title, { opacity: titleOpacity }]}>HEALTH INSURANCE SERVICES</Animated.Text>
            ...
            <View style={styles.conta}>
                <View style={styles.tabRow}>
                    <CustomButton 
                        label="RENTAL ITEM"
                        color="#00a1e4"
                        onPress={() => navigation.navigate('HealthInsuranceServices')}
                    />
                    <CustomButton
                        label="PURCHASE"
                        onPress={() => navigation.navigate('HealthInSPurchase')}
                        
                    />
                    <CustomButton
                        label="VENDORS"
                        onPress={() => navigation.navigate('HealthInSVendors')}
                    />
                </View>
            </View>
            <View style={{ flex: 1, alignItems: 'center' }}>
                <Image style={{ margin: 30, height: 160, width: 160 }} source={require('../../assets/images/healthinsuraces.png')} />
...
export default HealthInsuranceServices;
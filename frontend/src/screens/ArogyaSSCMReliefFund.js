...
const ArogyaSSCMReliefFund = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.content}>
                <Animated.Text style={[styles.title, { opacity: titleOpacity }]}>AROGYA SRI SERVICES</Animated.Text>
            ...
            <View style={styles.conta}>
                <View style={styles.tabRow}>
                    <CustomButton
                        label="SERFERY INFO"
                        onPress={() => navigation.navigate('ArogyaSriServices')}
                    />
                    <CustomButton
                        label="MEDICAL MANAGEMENT"
                        onPress={() => navigation.navigate('ArogyaSSMediMana')}
                    />
                    <CustomButton
                        label="DIALYSIS SERVICE"
                        onPress={() => navigation.navigate('ArogyaSSDiaServ')}
                    />
                </View>
                <View style={styles.tabRow}>
                    <CustomButton
                        label="ONCOLOGY SERVICE"
                        onPress={() => navigation.navigate('ArogyaSSOncoServ')}
                    />
                    <CustomButton
                        label="CM RELIEF FUND"
                        color="#00a1e4"
                        onPress={() => navigation.navigate('ArogyaSSCMReliefFund')}
                    />
                    <CustomButton
                        label="PM RELIEF FUND"
                        onPress={() => navigation.navigate('ArogyaSSPMReliefFund')}
                    />
                </View>
            </View>
            <View style={{ flex: 1, alignItems: 'center' }}>
                <Image style={{ margin: 20, height: 160, width: 160 }} source={require('../../assets/images/arogyaservi.png')} />
...
export default ArogyaSSCMReliefFund;
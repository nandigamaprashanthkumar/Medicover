...
const AmbulanceServiceCity = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.content}>
                <Animated.Text style={[styles.title, { opacity: titleOpacity }]}>AMBULANCE SERVICES</Animated.Text>
            ...
            <View style={styles.conta}>
                <View style={styles.tabRow}>
                    <CustomButton 
                        label="EMERGENCY"
                        onPress={() => navigation.navigate('AmbulanceServiceEmergency')}
                    />
                    <CustomButton
                        label="CITY SERVICE"
                        onPress={() => navigation.navigate('AmbulanceServiceCity')}
                        color="#00a1e4"
                    />
                    <CustomButton
                        label="WITHOUT CITY"
                        onPress={() => navigation.navigate('AmbulanceServiceWithoutCity')}
                    />
                </View>
            </View>
            <View style={{ flex: 1, alignItems: 'center' }}>
                <Image style={{ margin: 40, height: 150, width: 250 }} source={require('../../assets/images/ambulance.png')} />
                <TouchableOpacity style={styles.serviceButton} onPress={() => navigation.navigate('Servicerequest')}>
            ...
            <View style={styles.info}>
                ...
                <View style={styles.tat}>
                    <View style={styles.tao}>
                        <Text style={{ color: '#00a1e4', justifyContent: 'center', marginLeft: 25, marginTop: 12, fontSize: 15 }}>NARESH</Text>
                    </View>
                    <View style={styles.tao}>
...
export default AmbulanceServiceCity;
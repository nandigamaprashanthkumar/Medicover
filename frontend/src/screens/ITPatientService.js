...
const ITPatientService = ({ navigation }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.content}>
                <Animated.Text style={[styles.title, { opacity: titleOpacity }]}>IP PATIENT SERVICES</Animated.Text>
            ...
            <View style={styles.conta}>
                <View style={styles.tabRow}>
                    <CustomButton
                        ...
                        color="#00a1e4"
                        onPress={() => navigation.navigate('ITPatientService')}
                    />
                    <CustomButton
                        label="MEDICAL MANAGEMENT"
                        onPress={() => navigation.navigate('ITPSMediM')}
                    />
                    <CustomButton
                        label="DIALYSIS SERVICE"
                        onPress={() => navigation.navigate('ITPSDialysisS')}
                    />
                </View>
                <View style={styles.tabRow}>
                    <CustomButton
                        label="ONCOLOGY SERVICE"
                        onPress={() => navigation.navigate('ITPSOncologyS')}
                    />
                    <CustomButton
                        label="SURGERY"
                        onPress={() => navigation.navigate('ITPSSurgery')}
                    />
                    <CustomButton
                        label="CONSULTANT"
                        onPress={() => navigation.navigate('ITPSConsultant')}
                    />
                </View>
            </View>
...
export default ITPatientService;
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.content}>
                <Animated.Text style={[styles.title, { opacity: titleOpacity }]}>MY DESIGNATION</Animated.Text>
            ...
            <View style={styles.conta}>
                <View style={styles.tabRow}>
                    <Text style={{fontWeight:'500',color:'white',fontSize:15}}>DESIGNATION</Text>
                </View>
            </View>
            <View style={{ flex: 1, alignItems: 'center' }}>
                <Image style={{ margin: 40, height: 160, width: 140 }} source={require('../../assets/images/doctorss.png')} />
                <TouchableOpacity style={styles.serviceButton} onPress={handleServicePress}>
                    <Text style={styles.serviceButtonText}>ENROLL DETAILS</Text>
                </TouchableOpacity>
            </View>
            <View style={styles.info}>
                <View style={styles.tit}>
                    ...
                    <View style={styles.tick}>
                        <Text style={styles.ticktext}>DESIGNATION</Text>
                    </View>
                    <View style={styles.tick}>
                        {/* <Text style={styles.ticktext}>NAME</Text> */}
                    </View>
